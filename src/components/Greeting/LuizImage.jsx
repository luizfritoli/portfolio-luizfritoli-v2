import luizfritoliImg from "../../assets/icons/luizfritoli-img.jpg";
...
const LuizImage = () => {
  return (
    <figure className="flex flex-col items-center text-center">
      ...
      />
      <figcaption className="mt-2 md:mt-4 ml-6 mr-6 lg:mr-0 lg:ml-0 text-sm text-[#000] text-[1.1em] md:text-[1.5em]">
        Desenvolvedor web
      </figcaption>
    </figure>
  );
